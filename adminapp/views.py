...
def context_addition(key_name, key_value):
    def method_decorator(func):
        def wrapper(self, **kwargs):
            context = func(self, **kwargs)
            context[key_name] = key_value
            return context
        return wrapper
...
class CreateProductView(SuperUserPassesTestMixin, CreateView):
    ...
    @context_addition('links', PRODUCT_LINKS)
...
class CreateUserView(SuperUserPassesTestMixin, CreateView):
    ...
    @context_addition('links', USER_LINKS)
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
...
class CreateCategoryView(SuperUserPassesTestMixin, CreateView):
    ...
    @context_addition('links', CATEGORY_LINKS)
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
